...
- (UIImageView *)bgProgressView {
    if (!_bgProgressView) {
        ...
        _bgProgressView.backgroundColor = [UIColor colorWithRed:238/255.0
                                                          green:238/255.0
                                                           blue:238/255.0
                                                          alpha:1.0];
...
- (UIImageView *)sliderProgressView {
    if (!_sliderProgressView) {
        ...
        _sliderProgressView.backgroundColor = [UIColor colorWithRed:77/255.0 green:210/255.0 blue:109/255.0 alpha:1.0];
