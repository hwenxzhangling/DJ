...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        CGFloat perWidth = (KScreenW-leftM*2)/5;
        ...
        [self.slider mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.left.equalTo(self.sliderView).offset(leftM);
            make.right.equalTo(self.sliderView).offset(-leftM);
        }];
        ...
        [self.prevBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(self.playBtn.mas_left).offset(-perWidth);
            make.centerY.equalTo(self.playBtn.mas_centerY);
        }];
        
        [self.nextBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            make.right.equalTo(self.playBtn.mas_right).offset(perWidth);
            make.centerY.equalTo(self.playBtn.mas_centerY);
        }];
        
        [self.loopBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(self.prevBtn.mas_left).offset(-perWidth);
            make.centerY.equalTo(self.playBtn.mas_centerY);
        }];
        
        [self.listBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(self.nextBtn.mas_left).offset(perWidth);
            make.centerY.equalTo(self.playBtn.mas_centerY);
        }];
    }
    return self;
...
- (UILabel *)currentLabel {
    if (!_currentLabel) {
        ...
        _currentLabel.textColor = [UIColor colorWithRed:187/255.0 green:187/255.0 blue:187/255.0 alpha:1.0];
...
- (UILabel *)totalLabel {
    if (!_totalLabel) {
        ...
        _totalLabel.textColor = [UIColor colorWithRed:187/255.0 green:187/255.0 blue:187/255.0 alpha:1.0];
        _totalLabel.font = [UIFont systemFontOfSize:12.0];
    }
    return _totalLabel;
}

- (GKSliderView *)slider { //77 210 109
    if (!_slider) {
        _slider = [GKSliderView new];
        [_slider setBackgroundImage:[UIImage imageNamed:@"cm2_fm_playbar_btn44"] forState:UIControlStateNormal];
        [_slider setBackgroundImage:[UIImage imageNamed:@"cm2_fm_playbar_btn44"] forState:UIControlStateSelected];
        [_slider setBackgroundImage:[UIImage imageNamed:@"cm2_fm_playbar_btn44"] forState:UIControlStateHighlighted];
